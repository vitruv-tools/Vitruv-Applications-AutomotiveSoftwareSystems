...
/**
 * A helper class containing methods which are useful for both transformation
 * directions. Both for the reactions and for the test implementation.
 * 
...
public class ASEMSysMLReactionHelper {
	...
	/**
	 * Get the project model path for the ASEM model which corresponds to a
	 * SysML Block.
	 * 
	 * @param blockName
